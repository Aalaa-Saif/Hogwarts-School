    ...
    <div class="container">
        ...
        @endif
            ...
            <div class="card border-0 bg-dark crudcard">
                <div class="card-header text-light text-center"> Admin Register</div>
                <div class="card-body border-0 text-light">
                    <form method="POST" action="{{ route('admin_register') }}" class="loginCard img-fluid py-md-5" role="form">
                        @csrf
