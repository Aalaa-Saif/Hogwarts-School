    ...
    <div class="container">
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card bg-dark text-light crudcard">
                <div class="card-header text-center">Create a new Dapartment section</div>
                <div class="card-body text-ligh">
                    <form method="POST" action="{{ route('departmentStore') }}" enctype="multipart/form-data">
                        @csrf
