        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card bg-dark text-light crudcard">
                ...
                <div class="card-body text-light">
                    <form method="POST" action="{{ url('update/'.$show->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <span> <img style="width: 100px; height:100px;" src="{{asset('img/departments/'.$show->photo)}}"></span> <input type="file" class="form-control @error('photo') is-invalid @enderror" name="photo">
